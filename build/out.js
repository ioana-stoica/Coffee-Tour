...
function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return react_default.a.createElement("header", null, react_default.a.createElement("div", {
        id: "headerContainer"
      }, react_default.a.createElement("h1", null, " ", react_default.a.createElement(Link, {
        to: "/"
...
function (_React$Component) {
  ...
  navigation_createClass(Navigation, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("nav", null, react_default.a.createElement("menu", null, " MENU", react_default.a.createElement("ul", null, react_default.a.createElement("li", null, "About us"), react_default.a.createElement("li", null, "Contact us"))));
    }
  }]);
...
// CONCATENATED MODULE: ./js/myMap.jsx
function myMap_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { myMap_typeof = function _typeof(obj) { return typeof obj; }; } else { myMap_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return myMap_typeof(obj); }

function myMap_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function myMap_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function myMap_createClass(Constructor, protoProps, staticProps) { if (protoProps) myMap_defineProperties(Constructor.prototype, protoProps); if (staticProps) myMap_defineProperties(Constructor, staticProps); return Constructor; }

function myMap_possibleConstructorReturn(self, call) { if (call && (myMap_typeof(call) === "object" || typeof call === "function")) { return call; } return myMap_assertThisInitialized(self); }

function myMap_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function myMap_getPrototypeOf(o) { myMap_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return myMap_getPrototypeOf(o); }

function myMap_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) myMap_setPrototypeOf(subClass, superClass); }

function myMap_setPrototypeOf(o, p) { myMap_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return myMap_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_React$Component) {
  myMap_inherits(MyMap, _React$Component);

  function MyMap() {
    myMap_classCallCheck(this, MyMap);

    return myMap_possibleConstructorReturn(this, myMap_getPrototypeOf(MyMap).apply(this, arguments));
  }

  myMap_createClass(MyMap, [{
    key: "render",
    value: function render() {
...
/* harmony default export */ var myMap = (myMap_MyMap);
// CONCATENATED MODULE: ./js/carousel.jsx
function carousel_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { carousel_typeof = function _typeof(obj) { return typeof obj; }; } else { carousel_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return carousel_typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  carousel_inherits(Carousel, _React$Component);
  ...
  function Carousel() {
    ...
    _this = carousel_possibleConstructorReturn(this, (_getPrototypeOf2 = carousel_getPrototypeOf(Carousel)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      src1: '',
      src2: '',
      src3: '',
  ...
  carousel_createClass(Carousel, [{
    ...
    value: function render() {
      ...
      }, react_default.a.createElement("h2", null, " ", this.props.coffeeShop.name), react_default.a.createElement("div", {
        id: "slider"
...
// CONCATENATED MODULE: ./js/coffeeShopInfo.jsx
function coffeeShopInfo_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { coffeeShopInfo_typeof = function _typeof(obj) { return typeof obj; }; } else { coffeeShopInfo_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return coffeeShopInfo_typeof(obj); }

function coffeeShopInfo_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function coffeeShopInfo_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function coffeeShopInfo_createClass(Constructor, protoProps, staticProps) { if (protoProps) coffeeShopInfo_defineProperties(Constructor.prototype, protoProps); if (staticProps) coffeeShopInfo_defineProperties(Constructor, staticProps); return Constructor; }

function coffeeShopInfo_possibleConstructorReturn(self, call) { if (call && (coffeeShopInfo_typeof(call) === "object" || typeof call === "function")) { return call; } return coffeeShopInfo_assertThisInitialized(self); }

function coffeeShopInfo_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function coffeeShopInfo_getPrototypeOf(o) { coffeeShopInfo_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return coffeeShopInfo_getPrototypeOf(o); }

function coffeeShopInfo_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) coffeeShopInfo_setPrototypeOf(subClass, superClass); }

function coffeeShopInfo_setPrototypeOf(o, p) { coffeeShopInfo_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return coffeeShopInfo_setPrototypeOf(o, p); }




var coffeeShopInfo_CoffeeShopInfo =
/*#__PURE__*/
function (_React$Component) {
  coffeeShopInfo_inherits(CoffeeShopInfo, _React$Component);

  function CoffeeShopInfo() {
    coffeeShopInfo_classCallCheck(this, CoffeeShopInfo);

    return coffeeShopInfo_possibleConstructorReturn(this, coffeeShopInfo_getPrototypeOf(CoffeeShopInfo).apply(this, arguments));
  }

  coffeeShopInfo_createClass(CoffeeShopInfo, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("article", {
        id: "coffeeshop-info"
      }, react_default.a.createElement("h3", null, " Description "), react_default.a.createElement("p", null, " ", this.props.coffeeShop.description, " "));
    }
  }]);
...
/* harmony default export */ var coffeeShopInfo = (coffeeShopInfo_CoffeeShopInfo);
// CONCATENATED MODULE: ./js/details.jsx
...
/*#__PURE__*/
function (_React$Component) {
  details_inherits(Details, _React$Component);
  ...
  function Details() {
    ...
    _this = details_possibleConstructorReturn(this, (_getPrototypeOf2 = details_getPrototypeOf(Details)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      display: 'flex'
    };
    return _this;
  ...
  details_createClass(Details, [{
    ...
    value: function render() {
      ...
      }), react_default.a.createElement(coffeeShopInfo, {
        coffeeShop: this.props.coffeeShop
      }));
    }
  }]);
...
// CONCATENATED MODULE: ./js/middleSection.jsx
function middleSection_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { middleSection_typeof = function _typeof(obj) { return typeof obj; }; } else { middleSection_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return middleSection_typeof(obj); }

function middleSection_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function middleSection_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function middleSection_createClass(Constructor, protoProps, staticProps) { if (protoProps) middleSection_defineProperties(Constructor.prototype, protoProps); if (staticProps) middleSection_defineProperties(Constructor, staticProps); return Constructor; }

function middleSection_possibleConstructorReturn(self, call) { if (call && (middleSection_typeof(call) === "object" || typeof call === "function")) { return call; } return middleSection_assertThisInitialized(self); }

function middleSection_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function middleSection_getPrototypeOf(o) { middleSection_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return middleSection_getPrototypeOf(o); }

function middleSection_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) middleSection_setPrototypeOf(subClass, superClass); }

function middleSection_setPrototypeOf(o, p) { middleSection_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return middleSection_setPrototypeOf(o, p); }
...
var middleSection_MiddleSection =
/*#__PURE__*/
function (_React$Component) {
  middleSection_inherits(MiddleSection, _React$Component);

  function MiddleSection() {
    middleSection_classCallCheck(this, MiddleSection);

    return middleSection_possibleConstructorReturn(this, middleSection_getPrototypeOf(MiddleSection).apply(this, arguments));
  }

  middleSection_createClass(MiddleSection, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("section", {
        id: "middleSection"
...
/* harmony default export */ var middleSection = (middleSection_MiddleSection);
// CONCATENATED MODULE: ./js/filter.jsx
...
/*#__PURE__*/
function (_React$Component) {
  filter_inherits(Filter, _React$Component);

  function Filter() {
    filter_classCallCheck(this, Filter);

    return filter_possibleConstructorReturn(this, filter_getPrototypeOf(Filter).apply(this, arguments));
  }
  ...
  filter_createClass(Filter, [{
    ...
    value: function render() {
      return react_default.a.createElement("aside", {
        ...
        onClick: this.props.handleButton1
      }, "Has roastery"))), react_default.a.createElement("div", {
        id: "button2",
        className: "buttons"
      }, react_default.a.createElement("label", null, react_default.a.createElement("input", {
        type: "checkbox",
      ...
      }, "Serves food"))), react_default.a.createElement("div", {
        id: "button3",
        className: "buttons"
      }, react_default.a.createElement("label", null, react_default.a.createElement("input", {
        type: "checkbox",
        ...
        onClick: this.props.handleButton3
      }, "Pet friendly"))));
    }
  }]);
...
// CONCATENATED MODULE: ./js/content.jsx
...
function (_React$Component) {
  ...
  function Content() {
    ...
    _this = content_possibleConstructorReturn(this, (_getPrototypeOf2 = content_getPrototypeOf(Content)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      data: false,
      id: '',
      objCoffeeShop: {},
    ...
    _this.clearMap = function () {
      for (var j = 0; j < _this.state.markers.length; j++) {
        _this.state.map.removeLayer(_this.state.markers[j]);
      }
    };

    _this.addMarkerToMap = function (mymap, coffeshop) {
      var lat = coffeshop.latitude;
      var _long = coffeshop.longitude;
      var nameC = coffeshop.name;
      var id = coffeshop.id;
      var marker = L.marker([lat, _long], {
        id: id
      }).addTo(mymap);

      _this.state.markers.push(marker);

      marker.bindPopup("<b>".concat(nameC, "</b><br>Great coffee!"));
    };

    _this.getFilteredArray = function (roasteryFilter, foodFilter, petFilter) {
      var filteredArray = _this.state.data;

      if (roasteryFilter === true) {
        console.log("Filtru roasteryFilter");
        filteredArray = filteredArray.filter(function (data) {
          return data.hasRoastery === roasteryFilter;
        });
      }
      ...
      if (foodFilter === true) {
        ...
        filteredArray = filteredArray.filter(function (data) {
          return data.servesFood === foodFilter;
        });
      }
      ...
      if (petFilter === true) {
        ...
        filteredArray = filteredArray.filter(function (data) {
          return data.petFriendly === petFilter;
        });
      }
    ...
    _this.handleButton1 = function () {
      ...
      var filteredArray = _this.getFilteredArray(!_this.state.roasteryFilter, _this.state.foodFilter, _this.state.petFilter);

      for (var i = 0; i < filteredArray.length; i++) {
        _this.addMarkerToMap(_this.state.map, filteredArray[i]);
      }

      _this.setState({
        roasteryFilter: !_this.state.roasteryFilter
      });
    };
    ...
    _this.handleButton2 = function () {
      ...
      _this.setState({
        foodFilter: !_this.state.foodFilter
      });
    };
    ...
    _this.handleButton3 = function () {
      ...
      _this.setState({
        petFilter: !_this.state.petFilter
      });
    };
  ...
  content_createClass(Content, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('https://coffeeshops-dcd80.firebaseio.com/.json').then(function (resp) {
        return resp.json();
      }).then(function (resp) {
        _this2.setState({
          data: resp.coffeeShops
        }, function () {
          for (var i = 0; i < _this2.state.data.length; i++) {
            _this2.addMarkerToMap(mymap, _this2.state.data[i]);
          }
          ...
          mymap.on('popupopen', function (e) {
            ...
            var clickedCoffeeShop = _this2.state.data[clickedCoffeeShopId - 1];
    ...
    value: function render() {
      return react_default.a.createElement("div", {
        ...
        handleButton3: this.handleButton3,
        coffeeShop: this.state.objCoffeeShop
      }), react_default.a.createElement(middleSection, {
        id: this.state.id,
        coffeeShop: this.state.objCoffeeShop
      }));
    }
...
/* harmony default export */ var content = (content_Content);
// CONCATENATED MODULE: ./js/main-component.jsx
function main_component_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { main_component_typeof = function _typeof(obj) { return typeof obj; }; } else { main_component_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return main_component_typeof(obj); }

function main_component_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function main_component_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function main_component_createClass(Constructor, protoProps, staticProps) { if (protoProps) main_component_defineProperties(Constructor.prototype, protoProps); if (staticProps) main_component_defineProperties(Constructor, staticProps); return Constructor; }

function main_component_possibleConstructorReturn(self, call) { if (call && (main_component_typeof(call) === "object" || typeof call === "function")) { return call; } return main_component_assertThisInitialized(self); }

function main_component_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function main_component_getPrototypeOf(o) { main_component_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return main_component_getPrototypeOf(o); }

function main_component_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) main_component_setPrototypeOf(subClass, superClass); }

function main_component_setPrototypeOf(o, p) { main_component_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return main_component_setPrototypeOf(o, p); }
...
var main_component_MainComponent =
/*#__PURE__*/
function (_React$Component) {
  main_component_inherits(MainComponent, _React$Component);

  function MainComponent() {
    main_component_classCallCheck(this, MainComponent);

    return main_component_possibleConstructorReturn(this, main_component_getPrototypeOf(MainComponent).apply(this, arguments));
  }

  main_component_createClass(MainComponent, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("div", {
        id: "mainContainer"
      }, react_default.a.createElement(navigation, null), react_default.a.createElement(content, null));
    }
  }]);
...
/* harmony default export */ var main_component = (main_component_MainComponent);
// CONCATENATED MODULE: ./js/footer.jsx
...
function (_React$Component) {
  ...
  footer_createClass(Footer, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("footer", null, react_default.a.createElement("div", null, react_default.a.createElement("p", null, " ", react_default.a.createElement(Link, {
        to: "/"
      }, "\xA9 2020 Bucharest Coffee Tour"), " "), react_default.a.createElement("p", null, " About us "), react_default.a.createElement("p", null, " ", react_default.a.createElement(Link, {
        to: "/contact"
      }, " Contact "), " "), react_default.a.createElement("p", null, " ", react_default.a.createElement(Link, {
        to: "/Admin"
      }, " Admin "), " ")));
    }
  }]);
...
// CONCATENATED MODULE: ./js/main.jsx
...
function (_React$Component) {
  ...
  main_createClass(Main, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(header, null), react_default.a.createElement(main_component, null), react_default.a.createElement(footer, null));
    }
  }]);
...
// CONCATENATED MODULE: ./js/contact.jsx
...
var contact_ContactForm =
/*#__PURE__*/
function (_React$Component) {
  contact_inherits(ContactForm, _React$Component);
  ...
  function ContactForm() {
    ...
    contact_classCallCheck(this, ContactForm);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = contact_possibleConstructorReturn(this, (_getPrototypeOf2 = contact_getPrototypeOf(ContactForm)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      name: '',
      email: '',
      message: '',
  ...
  contact_createClass(ContactForm, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("form", {
        id: 'myForm',
        ...
        onChange: this.handleChange
      }), react_default.a.createElement("ul", null, this.state.formInfo.map(function (elem, index) {
...
function (_React$Component2) {
  contact_inherits(Contact, _React$Component2);
  ...
  contact_createClass(Contact, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(header, null), react_default.a.createElement("h2", null, " Contact us if you have any suggestions! "), react_default.a.createElement(contact_ContactForm, null), react_default.a.createElement(footer, null));
    }
  }]);
...
// CONCATENATED MODULE: ./js/admin.jsx
function admin_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { admin_typeof = function _typeof(obj) { return typeof obj; }; } else { admin_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return admin_typeof(obj); }
...
var admin_AdminLogin =
/*#__PURE__*/
function (_React$Component) {
  admin_inherits(AdminLogin, _React$Component);
  ...
  function AdminLogin() {
    ...
    admin_classCallCheck(this, AdminLogin);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = admin_possibleConstructorReturn(this, (_getPrototypeOf2 = admin_getPrototypeOf(AdminLogin)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      username: '',
      password: ''
    };
    ...
    _this.handleChange = function (event) {
      _this.setState(admin_defineProperty({}, event.target.name, event.target.value));
    };

    return _this;
  }

  admin_createClass(AdminLogin, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("form", {
        className: 'loginForm',
...
/*#__PURE__*/
function (_React$Component2) {
  admin_inherits(Admin, _React$Component2);

  function Admin() {
    admin_classCallCheck(this, Admin);

    return admin_possibleConstructorReturn(this, admin_getPrototypeOf(Admin).apply(this, arguments));
  }

  admin_createClass(Admin, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(header, null), react_default.a.createElement("h2", null, " Welcome to your administrator page "), react_default.a.createElement(admin_AdminLogin, null), react_default.a.createElement(footer, null));
    }
  }]);
...
// CONCATENATED MODULE: ./js/notFound.jsx
function notFound_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { notFound_typeof = function _typeof(obj) { return typeof obj; }; } else { notFound_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return notFound_typeof(obj); }
...
function (_React$Component) {
  ...
  notFound_createClass(NotFound, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement("h1", null, "404, Nothing is here");
    }
  }]);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function (_React$Component) {
    ...
    app_createClass(App, [{
      key: "render",
      value: function render() {
        return react_default.a.createElement(react_router_dom_HashRouter, null, react_default.a.createElement(react_router_Switch, null, react_default.a.createElement(react_router_Route, {
          exact: true,
          path: "/",
          component: main
